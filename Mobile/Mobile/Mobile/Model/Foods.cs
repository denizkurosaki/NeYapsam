...
namespace Mobile.Model
{
    class Foods
    {
        public static List<Food> foods = new List<Food>
        {
            ...
            new Food{ID = 18,    Image = "meal.png",    Label = "Patlıcan Musakka",    Calorie = "131 kcal"
            ,ingredients = new List<Ingredient>{ Ingredients.ing[23],Ingredients.ing[12] } },

            new Food{ID = 19,    Image = "meal.png",    Label = "Elmalı Turta",    Calorie = "442 kcal"
            ,ingredients = new List<Ingredient>{ Ingredients.ing[0],Ingredients.ing[8] } },
        };
